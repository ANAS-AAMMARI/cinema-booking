			  ...
			  <div class="nav-wrap">
					<ul class="group" id="example-one">
			           <li><a href="index.php">Home</a></li>
			  		   ...
			  		   $stmt = $con->prepare("SELECT * FROM tbl_registration WHERE user_id = :user_id");
                       $stmt->execute(['user_id' => $_SESSION['user']]);
                       $user = $stmt->fetch();
                       ?><a href="profile.php"><?php echo $user['name'];?></a><a href="logout.php">Logout</a><?php }else{?><a href="login.php">Login</a><?php }?></li>
			        </ul>
			  </div>
 			<div class="clear"></div>
   		</div>
