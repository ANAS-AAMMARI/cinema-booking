    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <?php
          try {
              $stmt = $con->prepare("SELECT * FROM tbl_theatre WHERE id = :id");
        ...
        <div class="box-body" id="screendtls">
          <?php
          try {
              $stmt = $con->prepare("SELECT * FROM tbl_screens WHERE t_id = :t_id");
              $stmt->execute(['t_id' => $_GET['id']]);
              ...
              <table class="table table-bordered table-hover">
                ...
                <th class="text-right col-md-3"><button data-toggle="modal" data-target="#view-modal" id="getUser" class="btn btn-sm btn-info"><i class="fa fa-plus"></i> Add Screen</button></th>
                  ...
                  while($screen = $stmt->fetch()) {
                      // Get show times for each screen
